...
class CourtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create court" do
    assert_difference('Court.count') do
      post courts_url, params: { court: { address: @court.address, category_id: @court.category_id, memo: @court.memo, name: @court.name } }
    end
  ...
  test "should update court" do
    patch court_url(@court), params: { court: { address: @court.address, category_id: @court.category_id, memo: @court.memo, name: @court.name } }
